...
public class MqttHandler extends SimpleChannelInboundHandler<MQMessage>
{
	private ConcurrentHashMap<SocketAddress, ConnectionListener> clientListeners;

	public MqttHandler(ConcurrentHashMap<SocketAddress, ConnectionListener> clientListeners)
	{
