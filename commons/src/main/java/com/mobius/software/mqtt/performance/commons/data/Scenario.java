...
public class Scenario extends GenericJsonRequest
{
	...
	public boolean validate()
	{
		...
		return properties != null && properties.validate() && count != null && threshold != null && continueOnError != null && commands != null && !commands.isEmpty() && startThreshold != null && isWs != null;
	}

	@Override
	public String toString()
	{
		return "Scenario [id=" + id + ", properties=" + properties + ", count=" + count + ", threshold=" + threshold + ", startThreshold=" + startThreshold + ", continueOnError=" + continueOnError + ", commands=" + commands + ", isWs=" + isWs + "]";
	}
