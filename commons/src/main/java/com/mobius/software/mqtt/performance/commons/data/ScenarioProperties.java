...
public class ScenarioProperties
{
	...
	public ScenarioProperties(String serverHostname, Integer serverPort, Integer wsServerPort, Integer scenarioDelay, Long resendInterval, Long minPingInterval, String identifierRegex, Integer startIdentifer, Repeat repeat)
	{
	...
	{
		return "ScenarioProperties [serverHostname=" + serverHostname + ", serverPort=" + serverPort + ", wsServerPort=" + wsServerPort + ", scenarioDelay=" + scenarioDelay + ", resendInterval=" + resendInterval + ", minPingInterval=" + minPingInterval + ", identifierRegex=" + identifierRegex + ", startIdentifier=" + startIdentifier + ", repeat=" + repeat + "]";
	}
	...
	public boolean validate()
	{
		...
		return serverHostname != null && serverPort != null && wsServerPort != null && resendInterval != null && minPingInterval != null && identifierRegex != null && startIdentifier != null && scenarioDelay != null;
	}
	...
	public Integer getWsServerPort()
	{
		return wsServerPort;
	}

	public void setWsServerPort(Integer wsServerPort)
	{
